...
function getRecipe(event) {
  ...
  let context =
    "User instructions: You are an extraordinary chef who wants to share their SHORT recipes. Make the title using <strong>.Your mission is to generate recipes and separate each line with <br/>. Make sure to follow the user instructions. Add 'SheCodes AI' as a <strong> element AT THE END of the recipe. ";
